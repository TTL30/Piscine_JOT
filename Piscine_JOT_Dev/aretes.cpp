...
Aretes::Aretes(std::string id, std::vector<float> p ,Sommet* s1, Sommet* s2, int taille, std::vector<bool> bolAr):m_id{id},m_poid{p},m_s1{s1}, m_s2{s2}, m_taille{taille},m_bolAr{bolAr}
{
}
